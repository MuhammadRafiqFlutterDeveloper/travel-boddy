...
class ChatPage extends StatefulWidget {
  ...
  final image;
  final uid;
  ChatPage({this.name, this.email, this.image, this.uid});
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: ListTile(
          ...
          title: Text(widget.name, style: postuser,),
          subtitle: Text(widget.email, style: title,),
        ),
      ),
      body: Column(
        children: [
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isCurrentUser = senderId == cUid;
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              isCurrentUser ? Colors.greenAccent : Colors.grey.withOpacity(0.20),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text(
                              // Convert timestamp to display format here
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Type a message...',hintStyle: textFireld
                      ),
                    ),
                  ),
                ),
...
//                 children: <Widget>[
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji1', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji1.gif',
//                       width: 50,
//                       height: 50,
...
//                   ),
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji2', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji2.gif',
//                       width: 50,
//                       height: 50,
...
//                   ),
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji3', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji3.gif',
//                       width: 50,
//                       height: 50,
...
//                 children: <Widget>[
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji4', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji4.gif',
//                       width: 50,
//                       height: 50,
...
//                   ),
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji5', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji5.gif',
//                       width: 50,
//                       height: 50,
...
//                   ),
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji6', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji6.gif',
//                       width: 50,
//                       height: 50,
...
//                 children: <Widget>[
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji7', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji7.gif',
//                       width: 50,
//                       height: 50,
...
//                   ),
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji8', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji8.gif',
//                       width: 50,
//                       height: 50,
...
//                   ),
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji9', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji9.gif',
//                       width: 50,
//                       height: 50,
...
//                 children: <Widget>[
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji10', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji10.gif',
//                       width: 50,
//                       height: 50,
...
//                   ),
//                   TextButton(
//                     onPressed: () => onSendMessage('emoji211', TypeMessage.sticker),
//                     child: Image.asset(
//                       'images/emoji211.png',
//                       width: 50,
//                       height: 50,
